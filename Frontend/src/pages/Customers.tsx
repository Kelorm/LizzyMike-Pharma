...
import { useCustomerPermissions } from '../hooks/usePermissions';
import { IfHasPermission } from '../components/ConditionalRender';

// Simple SearchBar component definition
...
const SearchBar: React.FC<SearchBarProps> = ({ value, onChange, placeholder }) => (
  <div className="relative">
    ...
    <input
      type="text"
      className="pl-10 border border-gray-300 rounded-lg px-3 py-2 w-full focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
      value={value}
...
interface CustomersProps {
  ...
  error?: string | null;
  customers?: Customer[];
  onOpenModal?: (type: string, item?: Customer) => void;
}

const Customers: React.FC<Partial<CustomersProps>> = ({
  loading = false,
  error = null,
  customers = [],
  onOpenModal = () => {},
                  ...
                  <tr key={customer.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex items-center justify-end space-x-2">
                        ...
                        <IfHasPermission permission="edit_customer">
                          <button
